            ...
            {siteConfig.primaryNav.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 h-8 inline-flex items-center text-[13px] font-medium rounded-md transition-colors whitespace-nowrap shrink-0 ${
                    isActive
        ...
        {siteConfig.primaryNav.map((item) => {
          ...
          return (
            <button
              key={item.id}
              onClick={() => onNavigate(item.id)}
              className={`flex items-center gap-1 px-3 py-1 text-xs font-medium rounded-full transition-all whitespace-nowrap shrink-0 ${
                isActive
